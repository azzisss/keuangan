	...
	<h1 class="">Akun</h1>
        ...
        <div class="row justify-content-center">
            ...
            <div class="d-flex justify-content-evenly flex-wrap flex-md-nowrap text-center pt-3 pb-2 mb-3 ">
                <h3 style="text-transform:capitalize" class="h4">Edit Akun</h3>
            </div>
                    ...
                    <form action="/akun/{{ $akun->id }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" required value="{{ old('name', $akun->name) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" autocomplete='off'
                                ...
                                placeholder="Username" value="{{ old('username', $akun->username) }}">
                            @error('username')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('id_akses') is-invalid @enderror" id="id_akses"
                                ...
                                @foreach ($akses as $item)
                                    @if (old('id_akses', $akun->id_akses) == $item->id)
                        ...
                        <div class="mb-3">
                            <a href="/changepass/{{ $akun->id }}" class="btn-sm btn-secondary">Change Password</a>
                        </div>
                        <div class="d-flex justify-content-center">
