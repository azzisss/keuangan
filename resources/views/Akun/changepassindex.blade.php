...
<div class="container-fluid px-4 mt-4">
	<h1 class="">Akun</h1>
		<ol class="breadcrumb mb-2 ">
		  ...
		  <li class="breadcrumb-item"><a href="/akun/{{ $akun->id }}/edit">Edit</a> </li>
	...
	<div class="row">
		...
		<div class="d-flex justify-content-center">
			<div class="col-lg-8">
				<form action="/change/{{ $akun->id }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="mb-3">
						<label for="name" class="form-label">Nama Akun</label>
						<input type="text" readonly class="form-control @error('name') is-invalid @enderror" id="name" name="name" required value="{{ old('name',$akun->name) }}">
